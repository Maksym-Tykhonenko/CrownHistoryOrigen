...
///////////////
import CrownHistoryOrigenProductScreen from './src/screens/CrownHistoryOrigenProductScreen';
...
const App = () => {
  ...
  const INITIAL_URL = `https://incredible-illustrious-fun.space/`;
  const URL_IDENTIFAIRE = `XFm35BK2`;
  ...
  OneSignal.initialize('1321c719-8cb0-4374-8cf3-d6973dde64ea');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-01-21T10:00:00'); //дата з якої поч працювати webView
            ...
            return (
                <Stack.Navigator>
                    <Stack.Screen
                        ...
                        name="CrownHistoryOrigenProductScreen"
                        component={CrownHistoryOrigenProductScreen}
